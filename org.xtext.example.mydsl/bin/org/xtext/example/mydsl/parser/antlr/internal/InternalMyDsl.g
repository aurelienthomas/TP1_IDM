...
@after {
	...
	(
		...
		(
			otherlv_3='in'
			{
				newLeafNode(otherlv_3, grammarAccess.getStateAccess().getInKeyword_3_0());
			}
			(
				(
					{
					...
					{
						newCompositeNode(grammarAccess.getStateAccess().getIncommingTransitionCrossReference_3_1_0());
					}
					ruleEString
					{
						afterParserOrEnumRuleCall();
		...
		(
			otherlv_5='out'
			{
				newLeafNode(otherlv_5, grammarAccess.getStateAccess().getOutKeyword_4_0());
			}
			(
				(
					{
					...
					{
						newCompositeNode(grammarAccess.getStateAccess().getOutgoingTransitionCrossReference_4_1_0());
					}
					ruleEString
					{
						afterParserOrEnumRuleCall();
...
@after {
	...
	(
		...
		(
			otherlv_3='to'
			{
				newLeafNode(otherlv_3, grammarAccess.getTransitionAccess().getToKeyword_3_0());
			}
			(
				(
					{
					...
					{
						newCompositeNode(grammarAccess.getTransitionAccess().getToStateCrossReference_3_1_0());
					}
					ruleEString
					{
						afterParserOrEnumRuleCall();
		...
		(
			otherlv_5='from'
			{
				newLeafNode(otherlv_5, grammarAccess.getTransitionAccess().getFromKeyword_4_0());
			}
			(
				(
					{
					...
					{
						newCompositeNode(grammarAccess.getTransitionAccess().getFromStateCrossReference_4_1_0());
					}
					ruleEString
					{
						afterParserOrEnumRuleCall();
